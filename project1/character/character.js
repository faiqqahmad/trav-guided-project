...
const renderCharacter = character => {
  ...
  homeworldSpan.innerHTML = `<a href="/planet/index.html?id=${character?.homeworld.id}">${character?.homeworld.name}</a>`;
  const filmsLis = character?.films?.map(film => `<li><a href="/film/index.html?id=${film.id}">${film.title}</li>`)
